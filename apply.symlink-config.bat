...
mklink  "c:\Users\bochu\Projects\symlink-config\selected\root\package.json" "..\..\package.json"
...
mklink  "c:\Users\bochu\Projects\symlink-config\selected\test-workspace\vscode_-_settings.json" "..\..\test-workspace\.vscode\settings.json"
